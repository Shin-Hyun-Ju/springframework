   ...
   <div class="card-body">
      <div class="card m-2">
         ...
         <div class="card-body">
            ...
            <%-- <a href="${pageContext.request.contextPath}/ch02/method?bkind=free" class="btn btn-info btn-sm">Get방식</a> --%>
         ...
         <script>
            function requestGet() {
               ...
               $.ajax({
                  url:"${pageContext.request.contextPath}/ch02/method",	//동적 context path
                  method: "GET",
