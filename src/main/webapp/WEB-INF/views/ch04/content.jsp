...
<!-- 태그 라이브러리 앞에는 form이라는 접두사를 붙여서 사용한다. -->
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%> <!-- library가 별도로 제공해주는 태그가 있다.(ex spring) 외부 라이브러리가 제공하는 태그를 쓰겠다 -->
...
<div class="card m-2">
   ...
   <div class="card-body">
      ...
      <div class="card m-2">
         ...
         <div class="card-body">
            <form id="form0" method="post" action="method1" onsubmit="checkData(this)">	<!-- 1차 유효성 검사, this는 현재 이벤트가 발생된 객체, event.target는 이벤트가 발생한 객체 -->
         ...
         <script>
            function checkData(form) {	//form element 객체가 매개변수로 들어오게 된다. -> 이벤트가 발샐한 객체
               //form의 제출 기능을 off
               ...
               //입력 길이 체크
               let param1 = form.param1.value;	//form객체 이름 안에서 이름이 param1인 것의 값을 가져와라
               ...
               <div class="card-body">         
                  <form method="post" action="join">
                     ...
                     <div class="input-group">
                        ...
                        <form:errors cssClass="text-danger" path="ch04Member.mpassword"/><!-- mpassword라는 에러로 등록되면 여기에 출력이 된다. -->
                     </div>
                     <div class="input-group">
