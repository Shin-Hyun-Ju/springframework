...
public class Ch13Service6InjectByXml {
	...
	private Set collection2; //중복 허용하지 않아. 집합이다.
	private Map collection3; //key-value
	private Properties collection4; //key-value인데 key와 value가 모두 String타입니다.
